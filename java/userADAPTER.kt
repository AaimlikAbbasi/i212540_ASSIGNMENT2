...
class UserAdapter(private val mContext: Context, private val mUsers: List<User>) : RecyclerView.Adapter<UserAdapter.ViewHolder>() {
        ...
        init {
            itemView.setOnClickListener {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    ...
                    val intent = Intent(mContext, MainActivity15::class.java).apply {
